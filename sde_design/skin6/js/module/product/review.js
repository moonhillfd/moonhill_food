            ...
            success: function(data) {
                ...
                if (data.is_secret == true) {
                    ...
                    if (data.write_auth == true) {
                        aHtml.push('<a href="/board/product/modify.html?board_act=edit&no='+data.no+'&board_no=4&link_product_no='+iProductNo+'" class="sp-btn" theme="white" scale="medium" change="edit"><span>게시글 수정하기</span></a>');
                    }
                    aHtml.push('</p>');
                    aHtml.push('</div>');
                ...
                $(pNode).after('<tr id="product-review-read'+data.key+'"><td colspan="6" id="sp-board-reply" class="sp-box" input="1" selecr="1" textarea="1">'+aHtml.join('')+'</td></tr>');
